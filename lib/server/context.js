...
import { slice } from 'meteor/ddp-common/utils';
...
export class Context {
  ...
  async subscribe (subName /*, params */) {
    ...
    if (publishHandler) {
      ...
      return await this.processPublication(publishContext, callbacks);
    } else {
  ...
  async processPublication (publishContext, callbacks) {
    const data = {};
